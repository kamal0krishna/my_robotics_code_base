#ifndef _ROS_robocon2021_Base_h
#define _ROS_robocon2021_Base_h
...
namespace robocon2021
{
  ...
  class Base : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "robocon2021/Base"; };
    virtual const char * getMD5() override { return "bbe0d1fcfecca90f6f938a52192a5ec2"; };
